...
- `GET https://lrclib.net/api/get`（用于同步歌词；合辑名不匹配时自动回退）
...
```text
https://cdn.jsdelivr.net/gh/DancingMusic/MusicConnect-iTunes@v0.5.3/dist/index.js
```
